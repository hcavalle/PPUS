...
<!--/*<//?php  /*  
// all from this wonderful site: http://net.tutsplus.com/tutorials/html-css-techniques/build-a-neat-html5-powered-contact-form/
if( isset($_POST) ){
	...
	if($formok){
		$headers = "From: info@playpickupsoccer.com" . "\r\n";
		...
		mail("harrison.cavallero@gmail.com","New Enquiry",$emailbody,$headers); //address being sent to
